...
class SignUpPresenterTests:  XCTestCase {
    ...
    func test_should_show_error_message_if_password_confirmation_is_not_provided() {
        ...
        XCTAssertEqual(alertViewSpy.viewModel, makeRequiredAlertViewModel(fieldName: "confirm password"))
    }
    ...
    func test_signUp_should_show_error_message_if_addAccount_fails() {
        ...
        XCTAssertEqual(alertViewSpy.viewModel, makeErrorAlertViewModel(message: "Something unexpected happend, try again in a few minutes."))
    }
}
